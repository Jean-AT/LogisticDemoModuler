...
| 003 | `ARC-002` Reorganizar build para compilar Angular y servirlo desde Spring Boot. | RNF-01 | ARC-001 | PENDIENTE |
| 004 | `ARC-003` Introducir `/api/v1`, `ProblemDetail`, paginacion y tipos comunes. | RNF-04, RNF-09 | ARC-001 | PENDIENTE |
| 005 | `ARC-004` Definir contratos de modulo, eventos, Outbox e idempotencia. | RNF-02, RNF-05 | ARC-003 | PENDIENTE |
| 006 | `ARC-005` Agregar ArchUnit y reglas de dependencia. | RNF-02 | ARC-004 | PENDIENTE |
...
| 409 | `LOG-T09` Migrar pantallas Angular, dashboards, PDFs y trazabilidad. | LOG-RF01-LOG-RF10 | LOG-T08 | PENDIENTE |
| 410 | `LOG-T10` Completar pruebas de dominio, API, migracion y frontend. | LOG-RF01-LOG-RF10 | LOG-T09 | PENDIENTE |
