...
CREATE TABLE presupuesto.budget_exercises (
    ...
    updated_by VARCHAR(100) NOT NULL,
    updated_at TIMESTAMP WITH TIME ZONE NOT NULL,
    CONSTRAINT uk_budget_exercise UNIQUE (company_id, fiscal_year, exercise_type)
);
...
CREATE TABLE presupuesto.budget_lines (
    ...
    CONSTRAINT uk_budget_line_dimension UNIQUE (
        budget_exercise_id, month, cost_center_id, financing_source_id,
        goal_id, expense_classifier_id, currency_code
    )
);
...
CREATE VIEW logistica_demo.stock_actual AS
SELECT item_id,
       almacen_id,
